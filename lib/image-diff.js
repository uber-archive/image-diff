...
function fillFromTo(gm, params) {
  ...
  gm.border(Math.max(params.toWidth - params.fromWidth, 0), Math.max(params.toHeight - params.fromHeight, 0));
  ...
  gm.crop(params.toWidth, params.toHeight, 0, 0);
          ...
          function resizeExpectedImage (cb) {
            tmp.tmpName({postfix: '.png'}, function (err, filepath) {
              ...
              // Otherwise, resize the image
                ...
                fillFromTo(this.gm(expectedPath), {
